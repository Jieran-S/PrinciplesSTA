...
Ripley's $K$ is a well established function to assess correlation in a point pattern. It can be calculated within a mark or across marks. In essence, Ripley's $K$ quantifies the average number of points that fall in a $r$-neighbourhood of a chosen mark [@ripleySecondOrderAnalysisStationary1976; @Baddeley2015 p. 132 ff.].
