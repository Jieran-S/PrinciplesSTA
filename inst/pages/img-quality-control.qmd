...
plotCentroidsSPE(cosmx, colour_by = "Mean.DAPI")
```
...
plotCentroidsSPE(cosmx[,cosmx$fov == 1], size = 1)
```
...
plotPolygonsSPE(cosmx[,cosmx$fov == 1])
```
...
colData(xenium) <- computeAspectRatioFromPolygons(xenium$polygons, colData(xenium))
...
#| code-fold: true
plotCentroidsSPE(cosmx, colour_by = "total")
plotCentroidsSPE(cosmx, colour_by = "Area_um")
```

```{r plot-qc-xy-xenium, fig.width=9, fig.height=3}
#| code-fold: true
plotCentroidsSPE(xenium, colour_by = "total_counts")
plotCentroidsSPE(xenium, colour_by = "cell_area")
```
...
plotCentroidsSPE(cosmx, colour_by = "log2CountArea")
plotCentroidsSPE(xenium, colour_by = "log2CountArea")
```
