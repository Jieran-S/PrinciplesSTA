...
plotPolygons(xenium[,box], colour_by = "transcript_counts", poly_column = "polygons.global")
```
...
In our example, DAPI stains and RNA target counts (`total`) are fairly constant across FOVs.
...
cosmx <- computeFilterFlags(cosmx, fs_threshold=0.5)
...
We can see how the quality score flags several cells close to FOV borders in the CosMX data and cells in the bottom-center damaged area in the Xenium data.
